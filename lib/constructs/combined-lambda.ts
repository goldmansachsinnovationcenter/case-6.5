 ...
 * Extends the L2 Function properties with both logging and VPC capabilities
 */
 ...
 */
export class CombinedLambda extends Construct {
  /**
   * The Lambda function
   */
  ...
  constructor(scope: Construct, id: string, props: CombinedLambdaProps) {
    ...
    if (this.vpc && this.securityGroups) {
    ...
    this.lambdaFunction = new lambda.Function(this, 'Function', lambdaProps);
  }
}
