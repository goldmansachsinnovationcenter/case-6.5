...
export class LambdaWithVpcExampleStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    new cdk.CfnOutput(this, 'LambdaWithNewVpcArn', {
      value: lambdaWithNewVpc.functionArn,
      description: 'ARN of the Lambda function with new VPC',
    });
    
    new cdk.CfnOutput(this, 'LambdaWithExistingVpcArn', {
      value: lambdaWithExistingVpc.functionArn,
      description: 'ARN of the Lambda function with existing VPC',
    });
    
    new cdk.CfnOutput(this, 'NewVpcLogGroupArn', {
      value: lambdaWithNewVpc.customLogGroup.logGroupArn,
      description: 'ARN of the CloudWatch log group for Lambda with new VPC',
    });
    
    new cdk.CfnOutput(this, 'ExistingVpcLogGroupArn', {
      value: lambdaWithExistingVpc.customLogGroup.logGroupArn,
      description: 'ARN of the CloudWatch log group for Lambda with existing VPC',
    });
